...
Torchbearer	Arsonist		Fire Master
...
Scenario 1	Frame 1 (Kingdom)	Scavenger, from The South Guard (mainline)
			Frames 2-4			Lord Bob
			Frame 5				Stefan, from A Tale of Two Brothers (mainline)
Scenario 2	Mountains			Lord Bob
Scenario 4	Swamp				Lord Bob
Scenario 10	Ship at sea			The Altaz Mariners, by Bob_the_Mighty and jb
Scenario 11	All Frames			Lord Bob
...
- Code updates for 1.11.x compatibility
- Added scenarios 10 and 11
- Player is now prevented from completing scenario 2 without rescuing Nivyan
- More story panels instead of dialogue
- New units added
-- Torchbearer, Arsonist, Fire Master
-- Village Elder (ai only)
-- Dark Cloud (ai only)
-- Rift, Shadow (ai only)
